/*
 Hier erledigen wir die Methoden f�r die Klasse Auto, eigentlich nur die Setters und Getters der Attributen
 auto.cpp
 */
...
{
    //wir untersuchen ob alle Paramter die Integers sind, gr��er als 0 sind
    if (km < 0 || preis < 0 || ps < 0)
        throw exception();

    //wir testen das Erstzulassungsjahr, ob es g�ltig ist, das hei�t, dass es soll maximal 2021 sein und gr��er als 0
