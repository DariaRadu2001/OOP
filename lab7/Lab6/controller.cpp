...
void Controller::controller_lesen_von_datei(string datei_name) {
    this->repo_auto.lesen_von_datei(datei_name);
}
...
void Controller_manager::controller_add(Auto car, string fname)
{
    this->repo_auto.add_auto(car, fname);
}

bool Controller_manager::controller_loschen(int id, string fname)
{
    return this->repo_auto.loschen_auto(id, fname);
}

bool Controller_manager::controller_bearbeiten(Auto car, string fname)
{
    return this->repo_auto.bearbeiten_auto(car, fname);
}
