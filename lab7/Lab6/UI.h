/*
  ...
  Als Paramterers haben wir das Controller für Kunde, das Controller für Manager und ein Key, das uns hilft
...
namespace ui {
    ...
    private:
        ...
        //Das Menu für der Kunde, wo wir alle Verwendungen des Kunde haben
        void menu_kunde();

        //Das Menu für der Manager, wo wir alle Verwendungen des Managers haben
        void menu_manager();

        /*Methode mitder wir prüfen, ob die gegebene Option von der Benutzer gültig ist.
        ...
        //Methode mitder wir prüfen, ob ein gegebenes Integer gut von dem Benutzer gegeben ist.
        ...
        /*
          ...
          Auto in seine Fav_Liste hinzufügen (Kunde Methode).
        */
        void fav_list_add();
        ...
        //der Manager fügt ein Auto, das er gibt, in der Liste hin (Manager Methode).
        void add();

        //der Manager löscht ein Auto aus der Liste, wenn das in der Liste gibt (Manager Methode).
        void loschen();
