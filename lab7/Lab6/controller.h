/*
 ...
 Das Controlller für Kunde und Manager vererben das "große" Controller
 controlller.h
 */
...
namespace controller {
    ...
    public:
        ...
        void controller_lesen_von_datei(string datei_name);
    ...
    public:
        ...
        void controller_add(Auto car, string fname);

        //Methode die das Löschmethode der Liste von Autos aus dem Repository ruft
        bool controller_loschen(int id, string fname);

        //Methode die das Bearbeitenmethode der Liste von Autos aus dem Repository ruft
        bool controller_bearbeiten(Auto car, string fname);
    };
};
