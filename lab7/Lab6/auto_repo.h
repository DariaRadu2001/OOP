...
public:
    ...
    virtual bool loschen_auto(int id, string fname) = 0;
...
namespace repo {
    ...
    public:
        ...
        */
        bool bearbeiten_auto(Auto car, string fname);
